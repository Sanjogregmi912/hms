...
public class AdminDetails implements ActionListener {
    public static void main(String[] args) {
        ...
        new AdminDetails();{
            ...
            search.setBounds(120,10,800,30);
            ...
            address.setBounds(120, 280, 500, 30);

            email_label.setBounds(40, 320, 100, 50);
            email_label.setText("Email:");

            email.setBounds(120, 330, 500, 30);
            ...
            AdminDetails_panel.add(lastname_label);
            AdminDetails_panel.add(age_label);
            AdminDetails_panel.add(address_label);
            AdminDetails_panel.add(contact_label);
            AdminDetails_panel.add(email_label);
            AdminDetails_panel.add(firstname_label);
            AdminDetails_panel.add(search_label);
            AdminDetails_panel.add(adminid_label);
            AdminDetails_panel.add(email_label);
            AdminDetails_panel.add(username_label);
            AdminDetails_panel.add(password_label);

            AdminDetails_panel.add(firstname);
            AdminDetails_panel.add(lastname);
            AdminDetails_panel.add(search);
            AdminDetails_panel.add(age);
            AdminDetails_panel.add(address);
            AdminDetails_panel.add(email);
            AdminDetails_panel.add(contact);
            AdminDetails_panel.add(adminid);
            AdminDetails_panel.add(username);
            AdminDetails_panel.add(password);

            AdminDetails_panel.add(update);
